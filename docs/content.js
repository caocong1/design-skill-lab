...
window.CONTENT = {
  ...
  styles: [
    ...
    { id: 'specimen', fonts: ['inter', 'sourcesans', 'condensed', 'nunito', 'zhuyuan', 'playfair', 'hanserif', 'garamond', 'baskerville', 'courier', 'jetbrains', 'wenkai', 'jost'], num: 14, name: '字样', en: 'Type Specimen',
      concept: '一份字体样张：十二个域各用一种系统字体的气质排出来（黑体、宋体、楷体、圆体、等宽、窄体……），大字看字形，小字看正文，每行标字号——把套件里"按气质选系统字体栈"那张表变成页面。',
      axes: { 字体: '十二种字体气质并置（在线字体 + 系统回落）', 色彩: '纸白 + 墨黑，仅此', 版式: '样张行 + 字号瀑布', 密度: '中', 形状: '无', 层次: '细横线', 动效: '样字换字体' },
    ...
    { id: 'island', fonts: ['zhuyuan', 'tangyuan', 'nunito'], num: 16, name: '小岛', en: 'Cute Island',
      concept: '一座低多边形小岛上的可爱 3D 小游戏（WebGPU 从零写起，没有引擎）：十二个域是十二座彩色小屋，你是一颗圆滚滚的小球，滚到门口就能进屋翻目录；S 首选在屋顶上亮着星星。套件本来就要设计游戏 HUD、3D 素材与沉浸式界面——这一页是它的美术指导、HUD 与动效一起落地。',
