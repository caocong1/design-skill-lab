...
| [Windows app design](https://learn.microsoft.com/en-us/windows/apps/design/) | Desktop conventions for Windows 11 apps: title bar, navigation view, materials, typography, input | Read before designing an Electron or Tauri app that should feel native on Windows | free · js | A |
